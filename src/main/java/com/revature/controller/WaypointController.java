...
/**
 * Controller responsible for managing HTTP requests for waypoints, communicates with waypoint service layer to persist
 * data in database
 */
@RestController()
...
public class WaypointController {
    ...
    /**
     * Constructor for instantiating a new instance of a waypoint service
     * @param waypointService the instantiation of the object
     */
    ...
    /**
     * Handles a POST request and calls service layer to create a new waypoint and persist to database
    ...
    /**
     * Handles a GET request and calls service layer to search database for a waypoint given a waypoint id
    ...
    /**
     * Handles a GET request and calls service layers, but instead searches for the waypoints of a trip
     * @param tripId the trip id of the trip that will return all the waypoints belonging to the trip
    ...
    /**
     * Handles a PUT request and calls service layer to update waypoints in the database, creates new waypoint
    ...
    /**
     * Handles a DELETE request and calls service layer to delete a waypoint in the database
