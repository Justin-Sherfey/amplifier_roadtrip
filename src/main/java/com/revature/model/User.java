...
/**
 * User model that will keep user information, users own trips that consist of waypoints. The username
...
public class User implements UserDetails {
    ...
    /**
     * Constructor for user objects used in testing, userId is auto-generated when persistsed to database
    ...
    /**
     * Methods used for authentication and secure different functionalities/data to specific users
     */
    @Override
